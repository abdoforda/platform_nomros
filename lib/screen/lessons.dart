...
class _LessonsState extends State<Lessons> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: _createLastSearch()
    );
  }

  Widget _createLastSearch(){
    final double boxImageSize = (MediaQuery.of(context).size.width / 2.5);
    double boxSize = MediaQuery.of(context).size.width / 2.4;
    return ListView.builder(
      itemCount: widget.teacher.units!.length,
      itemBuilder: (BuildContext context, int index){
        Units unit;
        unit = widget.teacher.units![index];
        return Column(
          children: [
            Container(
              ...
              child: Row(
                ...
                children: [
                  Text(unit.title.toString(), style: TextStyle(
                      fontSize: 16,
                      fontWeight: FontWeight.bold
                  )),
                  GestureDetector(
                    onTap: (){
                      Fluttertoast.showToast(msg: 'لا يوجد مزيد', toastLength: Toast.LENGTH_SHORT);
                    },
                    child: Text('مشاهدة الكل', style: TextStyle(
                        fontSize: 13,
                        fontWeight: FontWeight.bold,
                        color: PRIMARY_COLOR
            ...
            Container(
              ...
              child: ListView.builder(
                ...
                itemCount: unit.lectures!.length,
                itemBuilder: (BuildContext context, int index) {
                  Lectures l;
                  l = unit.lectures![index];
                  return Container(
                    ...
                    child: GestureDetector(
                      ...
                      onTap: () {
                        Navigator.push(context, CupertinoPageRoute(builder: (context) => Video(l)));
                      },
                      child: Column(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                ClipRRect(
                                  borderRadius: BorderRadius.circular(6),
                                  child: Container(
                                    color: l.isPaid! ? Color(0x4170FF48) : Color(0x41FF4848),
                                    padding: EdgeInsets.all(6),
                                    child: Icon(
                                      l.isPaid! ? Icons.lock_open :
                                      Icons.lock_outlined, color: l.isPaid! ? Colors.green : Colors.red, size: 14,),
                                  ),
                                )
                              ],
                            ),
