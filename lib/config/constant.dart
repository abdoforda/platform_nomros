...
const String GLOBAL_URL = 'http://devkit.ijteknologi.com';
const String GLOBAL_URL2 = 'https://meccacenter.site';
const String urlStatic = 'https://meccacenter.site/api';
const String urlImage = urlStatic+"/../storage/";
